...
## Understand and use essential tools
    ...
    - Archive, compress, unpack and uncompress files using
    tar, gzip and bzip2
    - Create and edit text files
    - Create, delete, copy and move files and directories
    - Create hard and soft links
    - List, set and change standard ugo/rwx permissions
    - Locate, read and use system documentation including
...
## Operate running systems
    ...
    system
    - Identify CPU/memory intensive process and kill
    process
    - Adjust process scheduling
    - Manage tuning profiles
    - Locate and interpret system log file and journals
...
## Deploy, configure and maintain systems
    ...
    Content Delivery Network, a remote repository or from
...
## Manage users and groups
    ...
    - Change passwords and adjust password aging for local
    user accounts
    - Create, delete and modify local groups and group
    memberships
    - Configure priviledge access
