# 0. Install a base lab to study

    Assuming that viewer have a computer and basic knowledge to use browser 
    and install virtualization software (Virtual Box, VMware Workstation,
    Virtual Machine Manager, Xen, LXC, etc.), in case need help send a message.

## 0.1 - Virtualization software
